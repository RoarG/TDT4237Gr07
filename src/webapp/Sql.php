...
class Sql
{
     ...
     */
    static function up() {
        $q1 = "CREATE TABLE users (id INTEGER PRIMARY KEY, user VARCHAR(50), pass VARCHAR(90), email varchar(50), age varchar(50), bio varchar(50), isadmin INTEGER), temppass varchar(40);";
